...
images = {"zeď_0" : pygame.image.load("../data/textury_hry/zeď_0.png").convert(),
          ...
          "lavicka_horizontalni" : pygame.image.load("../data/textury_hry/horizontalni_lavicka_base.png").convert_alpha(),
          "lavicka_horizontalni_konec_leva" : pygame.image.load("../data/textury_hry/horizontální_lavička.png").convert_alpha(),
          "lavicka_horizontalni_konec_prava" : pygame.transform.flip(pygame.image.load("../data/textury_hry/horizontální_lavička.png").convert_alpha(), True, False),
          "lavicka_vertikalni" : pygame.image.load("../data/textury_hry/lavička_vertikální.png").convert_alpha(),
          "lavicka_vertikalni_konec1" : pygame.image.load("../data/textury_hry/lavička_vertikální_konec.png").convert_alpha(),
          "lavicka_vertikalni_konec2" : pygame.image.load("../data/textury_hry/lavička_vertikální_konec_1.png").convert_alpha(),
          
          "skrinka_vertikalni" : pygame.image.load("../data/textury_hry/horizontální_skříňka.png").convert(),
          "skrinka_vertikalni_spodek" : pygame.image.load("../data/textury_hry/horizontální_skříňka_spodek.png").convert_alpha(),
          "skrinka_vertikalni_vrsek" : pygame.image.load("../data/textury_hry/horizontální_skříňka_vršek.png").convert_alpha(),
          ...
          "kos" : pygame.image.load("../data/textury_hry/koš_šatní.png").convert_alpha(),
          
          "odpatkove_pytle" : pygame.image.load("../data/textury_hry/pytel_biologického_odpdu.png").convert_alpha(),
