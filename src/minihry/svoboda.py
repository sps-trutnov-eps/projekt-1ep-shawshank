...
def main(language):
    ...
    krida = pygame.image.load(DATA_ROOT + "/data/textury_miniher/krida.png")
    libor = pygame.image.load(DATA_ROOT + "/data/textury_miniher/libor.png")
    lavice = pygame.image.load(DATA_ROOT + "/data/textury_miniher/lavice.png")
    tabule = pygame.image.load(DATA_ROOT + "/data/textury_miniher/tabule.png")
    vyhled = pygame.image.load(DATA_ROOT + "/data/textury_miniher/okno.png")
    hrac = pygame.image.load(DATA_ROOT + "/data/textury_miniher/hrac.png")
